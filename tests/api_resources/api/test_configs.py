...
class TestConfigs:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_by_path(self, client: Arbi) -> None:
        config = client.api.configs.get_by_path(
            "config_path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_by_path(self, client: Arbi) -> None:
        response = client.api.configs.with_raw_response.get_by_path(
            "config_path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_by_path(self, client: Arbi) -> None:
        with client.api.configs.with_streaming_response.get_by_path(
            "config_path",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_get_by_path(self, client: Arbi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `config_path` but received ''"):
            client.api.configs.with_raw_response.get_by_path(
                "",
            )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_save(self, client: Arbi) -> None:
        config = client.api.configs.save()
        assert_matches_type(ConfigSaveResponse, config, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_method_save_with_all_params(self, client: Arbi) -> None:
        config = client.api.configs.save(
            chunker={},
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_save(self, client: Arbi) -> None:
        response = client.api.configs.with_raw_response.save()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_save(self, client: Arbi) -> None:
        with client.api.configs.with_streaming_response.save() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncConfigs:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_by_path(self, async_client: AsyncArbi) -> None:
        config = await async_client.api.configs.get_by_path(
            "config_path",
        )
        assert_matches_type(AllConfigs, config, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_by_path(self, async_client: AsyncArbi) -> None:
        response = await async_client.api.configs.with_raw_response.get_by_path(
            "config_path",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_by_path(self, async_client: AsyncArbi) -> None:
        async with async_client.api.configs.with_streaming_response.get_by_path(
            "config_path",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_get_by_path(self, async_client: AsyncArbi) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `config_path` but received ''"):
            await async_client.api.configs.with_raw_response.get_by_path(
                "",
            )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_save(self, async_client: AsyncArbi) -> None:
        config = await async_client.api.configs.save()
        assert_matches_type(ConfigSaveResponse, config, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_save_with_all_params(self, async_client: AsyncArbi) -> None:
        config = await async_client.api.configs.save(
            chunker={},
            document_date_extractor_llm={
                "api_type": "local",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_save(self, async_client: AsyncArbi) -> None:
        response = await async_client.api.configs.with_raw_response.save()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_save(self, async_client: AsyncArbi) -> None:
        async with async_client.api.configs.with_streaming_response.save() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
