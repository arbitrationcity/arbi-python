...
from arbi import Arbi, AsyncArbi, APIResponseValidationError
from arbi._types import Omit
from arbi._models import BaseModel, FinalRequestOptions
from arbi._exceptions import ArbiError, APIStatusError, APITimeoutError, APIResponseValidationError
from arbi._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Arbi | AsyncArbi) -> int:
...
class TestArbi:
    client = Arbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ArbiError):
            with update_env(**{"ARBI_BEARER_TOKEN": Omit()}):
                client2 = Arbi(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Arbi) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ARBI_BASE_URL="http://localhost:5000/from/env"):
            client = Arbi(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Arbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Arbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Arbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Arbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Arbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("arbi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Arbi) -> None:
        respx_mock.get("/api").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.api.with_streaming_response.index().__enter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("arbi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Arbi) -> None:
    ...
    @mock.patch("arbi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Arbi, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.api.with_raw_response.index(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        self, client: Arbi, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.api.with_raw_response.index(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncArbi:
    client = AsyncArbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(ArbiError):
            with update_env(**{"ARBI_BEARER_TOKEN": Omit()}):
                client2 = AsyncArbi(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncArbi) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ARBI_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncArbi(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncArbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncArbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncArbi) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncArbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncArbi(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("arbi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncArbi) -> None:
        respx_mock.get("/api").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            await async_client.api.with_streaming_response.index().__aenter__()

        assert _get_open_connections(self.client) == 0

    @mock.patch("arbi._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncArbi) -> None:
        respx_mock.get("/api").mock(return_value=httpx.Response(500))
    ...
    async def test_retries_taken(
        ...
        response = await client.api.with_raw_response.index()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncArbi, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.api.with_raw_response.index(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.api.with_raw_response.index(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from arbi._utils import asyncify
        from arbi._base_client import get_platform
