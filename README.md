...
> [!NOTE]
> Once this package is [published to PyPI](https://app.stainless.com/docs/guides/publish), this will become: `pip install --pre arbi`
...
response = client.api.configs.update_update(
    configs={},
)
print(response.configs)
```
